...
class Zend_View_Helper_ProfileLink extends Zend_View_Helper_Abstract {
    public function profileLink() {
        ...
        if ($auth->hasIdentity ()) {
            ...
            $lienDeconnexion = $helperUrl->url ( array ('action' => 'deconnecter', 'controller' => 'utilisateur' ), 'default',true);
            $lienProfil = $helperUrl->url ( array ('action' => 'modifier', 'controller' => 'utilisateur' ), 'default',true);
            ...
            $lienConnexion = $helperUrl->url ( array ('action' => 'authentifier', 'controller' => 'utilisateur' ), 'default',true);
